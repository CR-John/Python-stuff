...
# * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
    ...
    def agregar_calificacion(self, cedula, codigo_curso, calificacion, fecha):  # metodo para agregar calificaciones
        ...
        if estudiante and curso:
            ...
            print('\n Parece qeue ingresaste un dato incorrecto, intente de nuevo')
    ...
    while True:
        ...
        #===============================================================================================================            
            ...
            while True:
                ...
                if opcion_curso == "1":
                    ...
                    print("Opcion no valida, reintente.")                           # valida la opcion dada por el usuario
        ...
        #===============================================================================================================            
            ...
            while True:
                ...
                if opcion_calificacion == "1":                                      # opcion para ingresar calificaciones
                    ...
                    calificacion = input("Ingrese la calificacion asignada (0-100): ")       # float pensando en que el usuario incluya decimales 
                    fecha = input("ingrese la fecha con el siguiente formato (YYYY-MM-DD): ")

                    sistema.agregar_calificacion(cedula, codigo_curso, calificacion, fecha)     # llama al metodo agregar_calificacion 

                elif opcion_calificacion == "2":                                    # opcion para ver las calificaciones por estudiante
                    cedula = input("Ingrese la cedula del estudiante: ")
        ...
        #===============================================================================================================
            ...
            while True:
                print('\n--- Reportes ---')                                         # menu de gestion de reportes
                ...
                if opcion_reporte == "1":
                    sistema.reporte_calificaciones_por_curso()                      # opcion para ver reporte_calificaciones_por_curso
                    
                elif opcion_reporte == "2":
                    sistema.reporte_promedio_ponderado()                            # opcion para ver el ponderado de los cursos
                    
                elif opcion_reporte == "3":                                         # opcion para volver al menu
                    break
                else:
                    print("Opcion no valida, reintente.")                           # valida la opcion dada por el usuario
...
if __name__ == "__main__":              # se da estructura al codigo general en caso de que el mismo sea importado
    login = Login()
    if login.solicitar_credenciales():  # ejecuta el control de acceso al menu, inicia cuando el login es true solamente
        menu()
